...
public class AnalizLexParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "','", "';'", "'('", "')'", "'{'", "'}'", "'+'", "'='", "'>'", 
		"'=='", "'&&'", "'%='", "'++'", "'true'", "'false'", "'var'", "'int'", 
		"'bool'", "'char'", "'write'", "'while'", "'prompt'", "'function'", "'return'", 
	...
	public final BContext b() throws RecognitionException {
		...
		try {
			...
			case IF:
				...
				setState(50); match(APARE);
				setState(51); e(0);
				setState(52); match(CPARE);
				setState(53); s();
				}
				break;
			case WHILE:
				enterOuterAlt(_localctx, 3);
				{
				setState(55); match(WHILE);
				setState(56); match(APARE);
				setState(57); e(0);
				setState(58); match(CPARE);
				setState(59); z();
				setState(60); match(ALLAV);
				setState(61); z();
				setState(62); c();
				setState(63); match(CLLAV);
				}
				break;
			case WRITE:
			case PROMPT:
	...
	public final FContext f() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(70); match(FUNCTION);
			setState(71); h();
			setState(72); match(ID);
			setState(73); match(APARE);
			setState(74); a();
			setState(75); match(CPARE);
			setState(76); z();
			setState(77); match(ALLAV);
			setState(78); z();
			setState(79); c();
			setState(80); match(CLLAV);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final SContext s() throws RecognitionException {
		...
		try {
			...
			case 3:
				...
				setState(88); match(APARE);
				setState(89); l();
				setState(90); match(CPARE);
				}
				break;
			case 4:
				enterOuterAlt(_localctx, 4);
				{
				setState(92); match(WRITE);
				setState(93); match(APARE);
				setState(94); l();
				setState(95); match(CPARE);
				}
				break;
			case 5:
				enterOuterAlt(_localctx, 5);
				{
				setState(97); match(PROMPT);
				setState(98); match(APARE);
				setState(99); match(ID);
				setState(100); match(CPARE);
				}
				break;
			case 6:
			...
			case 7:
				...
				setState(107); match(PCOMA);
				setState(108); e(0);
				setState(109); match(PCOMA);
				setState(110); e(0);
				setState(111); match(PCOMA);
				setState(112); match(CPARE);
				setState(113); match(ALLAV);
				setState(114); e(0);
				setState(115); match(CLLAV);
				}
				break;
			}
		}
	...
	public final VContext v() throws RecognitionException {
		...
		try {
			...
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(196); match(APARE);
				setState(197); e(0);
				setState(198); match(CPARE);
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
	...
	public final ZContext z() throws RecognitionException {
		...
		try {
			...
			case 1:
				enterOuterAlt(_localctx, 1);
				{
				setState(211); match(DEL);
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
				{
				setState(212); match(DEL);
				setState(213); z();
				}
				break;
			}
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		...
		case 13: return r_sempred((RContext)_localctx, predIndex);
		case 14: return u_sempred((UContext)_localctx, predIndex);
		}
		return true;
	}
